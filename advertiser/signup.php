    ...
    if (isset($_POST['signup'])) {
       ...
       if ($email_row>0) {
           $fetch_data = mysqli_fetch_assoc($email_query_run);
            ...
            $tbl_corordinator_query = "select * from tbl_corordinator where user_id = '$user_id' and user_type_id = 3";
           ...
           if ($tbl_corordinator_row == 1) {
             $status = "Email Already Registed";
              ...
              if ($password === $cpassword) {
                ...
                $tbl_corordinator_insert_query = "insert INTO `tbl_corordinator`(`user_id`, `user_type_id`) VALUES ('$user_id','3')";
        ...
        if ($password === $cpassword) {
          ...
          $hash_password = password_hash($password, PASSWORD_BCRYPT);
            ...
            $insert_query = "insert into user(name, email, phone, password, is_brand, verification_code, is_verified) values('$name', '$email', '$phone', '$hash_password','1','$verification_code','0')";
    ...
    function sendMail($email, $name, $verification_code)
    {
      ...
      try {
        ...
        $mail->Body    = "Hello $name,<br> Thanks for registration! <br> 
                  <a href='http://localhost/audiobook2/advertiser/verify.php?email=$email&verification_code=$verification_code'>Click Here</a> to verify you Account.<br>
                  Thank You";
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Sign Up to advertiser account </strong></h3>
        </div>
        <div class="row justify-content-center mt-4">
            <center><p><?php if(isset($status)){ echo $status; } ?></p></center>
                ...
                <form action="#" method="post" class="mbr-form form-with-styler mx-auto">
                    ...
                    <div class="dragArea row">
                        ...
                        <div data-for="password" class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                            <input type="password" name="password" placeholder="Password" data-form-field="password" class="form-control" value="" id="password-form7-f">
                        </div>
                        <div data-for="cpassword" class="col-lg-12 col-md-12 col-sm-12 form-group mb-3">
                            <input type="password" name="cpassword" placeholder="Confirm Password" data-form-field="cpassword" class="form-control" value="" id="cpassword-form7-f">
                        </div>
