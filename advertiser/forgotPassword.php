<?php
  ...
  if (isset($_POST['reset-password'])) {
    ...
    if ($check_account_row_no == 1) {
      ...
      $reset_password_status = "Email not found! Please <a href='http://localhost/audiobook2/advertiser/signup.php'>Sign Up</a>";
    }
  }
  ...
  function sendMail($email, $name, $reset_token)
    {
      ...
      try {
        ...
        $mail->Body    = "Hello $name,<br> Thanks for being a member! <br> 
                  ...
                  <a href='http://localhost/audiobook2/advertiser/set-password.php?email=$email&token=$reset_token'>Reset Password</a><br>
                  Thank You";
                ...
                <form action="#" method="post" class="mbr-form form-with-styler mx-auto">
                    ...
                    <h5 style="color:red;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <input type="email" name="reg-email" placeholder="Email" class="form-control" id="name-form7-d" required>
                        </div>
