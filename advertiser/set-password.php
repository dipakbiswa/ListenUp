    ...
    //Password Encripting
        ...
        if ($password === $cpassword) {
          ...
          if ($update_password_run) {
            $set_password_status = "Password Updated! <a href='http://localhost/audiobook2/advertiser/login.php'> Login Now</a>";
          }
        }
        else{
                ...
                <form action="#" method="post" class="mbr-form form-with-styler mx-auto">
                    ...
                    <h5 style="color:red;">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <input type="password" name="new_password" placeholder="Password" class="form-control" id="name-form7-d" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <input type="password" name="new_cpassword" placeholder="Confirm Password" class="form-control" id="name-form7-d" required>
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group mb-3" data-for="name">
                            <input type="hidden" name="email" value="<?php echo $_GET['email']; ?>" class="form-control" id="name-form7-d" required>
                        </div>
