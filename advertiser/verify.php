<?php 
	...
	if (isset($_GET['email']) && $_GET['verification_code']) {
		...
		if ($is_verify == 0) {
			...
			if ($verify_query_run) {
				$verify_status = "Your Account verified please <a href='http://localhost/audiobook2/advertiser/login.php'>login</a>";
			}
			
		}
		else{
			$verify_status = "Your Account is already verified please <a href='http://localhost/audiobook2/advertiser/login.php'>login</a>";
		}
    ...
    <div class="container">
        <div class="mbr-section-head">
            <h3 class="mbr-section-title mbr-fonts-style align-center mb-0 display-2">
                <strong>Verify your artist account</strong></h3>
        </div>
