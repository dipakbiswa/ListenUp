...
<?php 
    ...
    if(isset($_POST['upload'])){
        ...
        $dest_path = "../assets/slideshow_images/";
        $file = $dest_path.$name;
        $insert_query_run = mysqli_query($conn, "insert INTO `slideshow`(`image_name`) VALUES ('$name')");
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">New Slideshow</h1>
				    </div>
			    </div><!--//row-->
