...
<?php 
	...
	if(isset($_POST['delete'])){
		$id = $_POST['id'];
		$delete_query_run = mysqli_query($conn, "delete from notification where id = '$id'");
		if($delete_query_run){
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    ...
				    <a href="sendNotification.php" class="btn btn-success">Send Notification</a>
					<br>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Published By</th>
												<th class="cell">Action</th>
											</tr>
										</thead>
										<tbody>
											<?php
											$query_run = mysqli_query($conn, "select * from notification order by id desc");
											while($row = mysqli_fetch_assoc($query_run)){?>
											<tr>
												<td class="cell"><?php echo $row['id']; ?></td>
												<td class="cell"><?php echo $row['subject']; ?></td>
												<td class="cell"><?php echo $row['message']; ?></td>
												<td class="cell"><?php echo $row['published_by']; ?></td>
