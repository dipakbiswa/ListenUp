...
<?php 
	...
	if(isset($_POST['delete'])){
        ...
        $file = "../assets/slideshow_images/".$image_name;
		$delete_query_run = mysqli_query($conn, "delete from slideshow where id = '$id'");
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Slideshow</h1>
				    </div>
				    <a href="newSlideshow.php" class="btn btn-success">New Slideshow</a>
					<br>
						    ...
						    <div class="app-card-body">
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										...
										<tbody>
											<?php
											$query_run = mysqli_query($conn, "select * from slideshow");
											while($row = mysqli_fetch_assoc($query_run)){?>
											<tr align="center">
												<td class="cell"><?php echo $row['id']; ?></td>
												<td class="cell"><img src="../assets/slideshow_images/<?php echo $row['image_name']; ?>" style="width: 50%;"></td>
