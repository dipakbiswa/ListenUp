	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Audiobooks</h1>
				    </div>
							        ...
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr>
												...
												<th class="cell">Is Paid</th>
												<th class="cell">Action</th>
											</tr>
										</thead>
										<tbody>
											<?php
											$query_run = mysqli_query($conn, "select * from audiobook");
											while($row = mysqli_fetch_assoc($query_run)){
                                                $category_name_fetch = mysqli_fetch_assoc(mysqli_query($conn, "select * from category where id = ".$row['category_id']));
                                                ?>
                                            
											<tr>
												<td class="cell"><?php echo $row['id']; ?></td>
												<td class="cell"><img src="../assets/banner/<?php echo $row['banner_name']; ?>" alt="user profile" style="height: 50px; width: 50px; border-radius: 5px;"></td>
												<td class="cell"><?php echo $row['title']; ?></td>
												<td class="cell"><?php echo $row['artist_name']; ?></td>
												<td class="cell"><?php echo $category_name_fetch['name']; ?></td>
												<td class="cell"><span class="badge bg-danger"><?php echo $row['is_paid'] ==1 ? "Yes" : "No"; ?></span></td>
												<td class="cell">
