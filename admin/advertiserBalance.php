...
<html lang="en"> 
<head>
    <title>Advertiser Balance</title>
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Advertiser Balance</h1>
				    </div>
							    ...
							    <div class="table-responsive">
							        <table class="table app-table-hover mb-0 text-left">
										<thead>
											<tr align="center">
												<th class="cell">Id</th>
                                                <th class="cell">Advertiser Name</th>
										...
										<tbody>
											<?php
											$query_run = mysqli_query($conn, "select * from balance");
											...
											<tr align="center">
												...
												<td class="cell"><?php echo $row['tid']; ?></td>
